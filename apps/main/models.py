...
class Material(ModelBase):
    code = models.CharField(max_length=255, verbose_name="code",
                            unique=True, help_text="Código del material")
    serial = models.CharField(
        max_length=255, verbose_name="serial", unique=True, help_text="Serial del material")
...
class Schedule(ModelBase):
    ...
    start_time = models.TimeField(
        blank=True, null=True, help_text="Hora Inicial")
    final_hour = models.TimeField(
        blank=True, null=True, help_text="Hora final")
    is_active = models.BooleanField(default=True)


class MaterialNews(ModelBase):
    material = models.ForeignKey(Material, verbose_name=_(
        'material'), blank=True, on_delete=models.PROTECT)
    news = models.ForeignKey('main.News', verbose_name=_(
        'news'), blank=True, on_delete=models.PROTECT)
...
class VehicleNews(ModelBase):
    vehicle = models.ForeignKey(Vehicle, verbose_name=_(
        'vehicle'), on_delete=models.PROTECT)
    news = models.ForeignKey('main.News', verbose_name=_(
        'news'), on_delete=models.PROTECT)
...
class TypePerson(ModelBase):
    ...
    priority = models.CharField(
        max_length=255, verbose_name="code", help_text="Prioridad del tipo de persona")
    is_active = models.BooleanField(default=True)


class Person(ModelBase):
    code = models.CharField(max_length=255, verbose_name="code",
                            unique=True, help_text="Código de la persona")
    name = models.CharField(
        max_length=255, verbose_name="name", help_text="Nombre de la persona")
    last_name = models.CharField(
        max_length=255, verbose_name="lastname", help_text="Apellido de la persona")
    ...
    address = models.CharField(
        max_length=255, verbose_name="address", help_text="Dirección de la persona")
    phone = models.CharField(
        max_length=255, verbose_name="phone", help_text="Teléfono de la persona")
    mobile = models.CharField(
        max_length=255, verbose_name="mobile", help_text="Número de celular de la persona")
...
class PersonNews(ModelBase):
    persons = models.ForeignKey(Person, verbose_name=_(
        'persons'), on_delete=models.PROTECT)
    news = models.ForeignKey('main.News', verbose_name=_(
        'news'), on_delete=models.PROTECT)
...
class News(ModelBase):
    ...
    message = models.TextField(verbose_name=_(
        'message'), help_text="Mensaje de la novedad")
...
class Location(ModelBase):
    ...
    code = models.CharField(max_length=255, verbose_name=_(
        'code'), unique=True, null=False, blank=False)
    name = models.CharField(max_length=255, verbose_name=_(
        'name'), unique=True, null=False, blank=False)
    phone1 = models.CharField(max_length=255, verbose_name=_(
        'phone1'), blank=True, null=True)
    phone2 = models.CharField(max_length=255, verbose_name=_(
        'phone2'), blank=True, null=True)
    status = models.SmallIntegerField(
        choices=STATUS, default=ACTIVE, verbose_name=_('status'))
