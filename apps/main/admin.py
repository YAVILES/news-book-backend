...
from apps.main.models import TypePerson, Material, Vehicle, Person, News, Schedule, Location, Point
...
class PointAdmin(TenantAdminMixin, admin.ModelAdmin):
    list_display = ('code', 'name',)
